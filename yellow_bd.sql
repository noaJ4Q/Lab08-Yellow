CREATE DATABASE  IF NOT EXISTS `yellow` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `yellow`;
...
INSERT INTO `dropeo` VALUES (1,2,0.4),(2,1,0.6),(3,4,0.7),(4,3,0.3),(5,5,0.4);
...
INSERT INTO `heroe` VALUES (1,'Urhan','30','M','Caballero',50,40,142500,4),(2,'Ataz','350','F','Curandero',12,20,979.2,3),(3,'Ophior','120','F','Bestia',20,230,5440,2),(4,'Atosh','560','M','Guardabosque',70,100,459620,1),(5,'Ilrolius','90','O','Mago',5,560,65,NULL);
...
INSERT INTO `inventario` VALUES (1,2,4),(1,4,1),(2,2,1),(2,5,2),(2,4,3),(3,1,4),(3,2,1),(3,3,1),(4,5,1),(4,2,5),(4,1,4),(5,2,3),(5,4,2),(5,1,4),(1,5,2);
...
-- Dump completed on 2022-11-07 18:39:43
