              ...
              <div class="col-12">
                <div class="card top-selling overflow-auto">
                  ...
                  <div class="card-body pb-0">
                    <h5 class="card-title">EDITAR OBJETO</h5>
                    <form method="post" action="<%=request.getContextPath()%>/MenuHeroes?action=actualizarObjeto&idHeroe=<%=idHeroe%>&idObjeto=<%=idObjeto%>">
                      <div class="row mb-3">
                        <label for="cantidad"
